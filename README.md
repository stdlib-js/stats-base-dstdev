...
```javascript
dstdev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dstdev@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-dstdev/tags). For example,

```javascript
dstdev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dstdev@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dstdev = require( 'path/to/vendor/umd/stats-base-dstdev/index.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-dstdev.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-dstdev

[test-image]: https://github.com/stdlib-js/stats-base-dstdev/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-base-dstdev/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-dstdev/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-dstdev?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-dstdev.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-dstdev/main
...
[deno-url]: https://github.com/stdlib-js/stats-base-dstdev/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-base-dstdev/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-dstdev/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-dstdev/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-dstdev/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-dstdev/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-dstdev/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-dstdev/main/LICENSE
